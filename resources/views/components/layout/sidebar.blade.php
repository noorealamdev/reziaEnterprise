...
>
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto p-4">
        ...
        @can('sajjat.view')
            <x-layout.sidebar-link :href="route('sajjat.index')" :active="request()->routeIs('sajjat.index')">
                <x-slot:icon>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        @can('sajjat.newspapers.view')
            <x-layout.sidebar-link :href="route('sajjat.newspapers')" :active="request()->routeIs('sajjat.newspapers')" class="{{ Gate::allows('sajjat.view') ? 'ml-5' : '' }}">
                <x-slot:icon>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M5 4.5h11a1 1 0 0 1 1 1V19a1.5 1.5 0 0 0 1.5 1.5h0A1.5 1.5 0 0 0 20 19V9.5h-3" />
                        <path d="M5 4.5V18a2.5 2.5 0 0 0 2.5 2.5h11" />
